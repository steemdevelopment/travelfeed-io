...
// CONCATENATED MODULE: ./components/AuthorProfile.js
...
var AuthorProfile_PostAuthorProfile =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(PostAuthorProfile, [{
    ...
    value: function () {
      ...
      regenerator_default.a.mark(function _callee() {
        var acc, profiledesc, cover, json;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                cover = "https://cdn.steemitimages.com/DQme1phKjAipUM1zg5GQNaobssCMgmLAvFLFTVJpe9YVSvv/Steem_Gradient_Blue.png";

                if (acc[0].json_metadata != "") {
                  json = JSON.parse(acc[0].json_metadata);
                  profiledesc = json.profile.about != "" ? json.profile.about : "A TravelFeed author.";
                  cover = typeof json.profile.cover_image != "undefined" ? "https://steemitimages.com/1500x0/".concat(json.profile.cover_image) : "https://cdn.steemitimages.com/DQme1phKjAipUM1zg5GQNaobssCMgmLAvFLFTVJpe9YVSvv/Steem_Gradient_Blue.png";
                }
    ...
    value: function render() {
      ...
      })), external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement("div", null, external_react_default.a.createElement(Typography_default.a, {
        variant: "title",
...
/* harmony default export */ var AuthorProfile = (AuthorProfile_PostAuthorProfile);
...
function blog_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function blog_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { blog_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { blog_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
var blog_client = new external_dsteem_["Client"]("https://api.steemit.com");
...
function (_Component) {
  ...
  function Blog() {
    ...
    return blog_possibleConstructorReturn(this, blog_getPrototypeOf(Blog).apply(this, arguments));
  }
  ...
  blog_createClass(Blog, [{
    ...
    value: function render() {
      if (typeof this.props.args.stream.notfound !== "undefined") {
        return external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement(external_react_helmet_default.a, null, external_react_default.a.createElement("title", null, "404 - Not Found")), external_react_default.a.createElement(Grid_default.a, {
          container: true,
          spacing: 0,
          alignItems: "center",
          justify: "center"
          ...
          sm: 11,
          xs: 12
        }, external_react_default.a.createElement(Card_default.a, null, external_react_default.a.createElement(CardContent_default.a, null, external_react_default.a.createElement(Typography_default.a, null, "This author is not a valid account."))))));
        ...
        return external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement(external_react_helmet_default.a, null, external_react_default.a.createElement("title", null, "404 - Not Found")), external_react_default.a.createElement(Grid_default.a, {
          ...
          sm: 11,
          xs: 12
        }, external_react_default.a.createElement(Card_default.a, null, external_react_default.a.createElement(CardContent_default.a, null, external_react_default.a.createElement(Typography_default.a, null, "This author is blacklisted from TravelFeed."))))));
      } else {
        var author = this.props.args.author.replace(/^\w/, function (c) {
          return c.toUpperCase();
        });
        var description = author + "'s Blog on TravelFeed. Join the TravelFeed community, write your own travel blog and start earning!";
        return external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement(external_react_helmet_default.a, null, external_react_default.a.createElement("title", null, author + "'s Blog on TravelFeed: The Travel Community"), external_react_default.a.createElement("meta", {
          property: "description",
          content: description
        }), external_react_default.a.createElement("meta", {
          property: "og:description",
          content: description
        })), external_react_default.a.createElement(AuthorProfile, {
    ...
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = blog_asyncToGenerator(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(props) {
        var author, stream, args, _stream, _stream2;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(Object(isBlacklisted["a" /* default */])(author, "none") === true)) {
                  _context.next = 4;
                  break;
                }
              ...
              case 4:
                ...
                _context.prev = 5;
                _context.next = 8;
                return blog_client.database.getDiscussions("blog", args);
              ...
              case 12:
                ...
                return _context.abrupt("return", _stream2);
