...
export default {
  vimeo: {
    ...
    html: '<iframe style="width:100%;" height="390" frameborder="0"></iframe>',
    height: 390,
    width: 580,
  },
  youtube: {
    regex: /(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:(?:youtu\.be\/)|(?:youtube\.com)\/(?:v\/|u\/\w\/|embed\/|watch))(?:(?:\?v=)?([^#&?=]*))?((?:[?&]\w*=\w*)*)/,
    embedUrl: 'https://www.youtube.com/embed/<%= remote_id %>',
    html:
      '<iframe style="width:100%;" height="390" frameborder="0" allowfullscreen></iframe>',
    height: 390,
    width: 580,
    id: ([id, params]) => {
      if (!params && id) {
