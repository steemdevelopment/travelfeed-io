(function(tinymce) {
  ...
  var SERVICES = ["google_staticmap", "google_embed", "google_coordinates"];
  SERVICES["google_coordinates"] = {
    name: "Coordinates",
  ...
  function buildMap(data, useInlineStyle) {
    ...
    var gmaps_url = buildURL(service.api, data);
    var coordinates = location;
    var swmsnippet = "invalid coordinates";
    if (coordinates != undefined && coordinates.includes(",")) {
      coordinates = coordinates.split(",");
      var lat = coordinates[0];
      var long = coordinates[1];
      swmsnippet = "!steemitworldmap " + lat + " lat " + long + " long d3scr";
    }
    var html = "";
    if (type === "iframe") {
      html =
        ...
        '" />';
      if (useInlineStyle) {
        html = "<" + type + ' src="' + gmaps_url + '" height="' + 80 + '" />';
      }
    }
    if (type === "comment") {
      html = "[//]:# (" + swmsnippet + ") ";
  ...
  function Plugin(editor, url) {
    ...
    SERVICES.forEach(function(name) {
      ...
      service.key =
        ...
        "AIzaSyAi-8Wbef7LTSeHiArKDOGTnlObtGxa8gc";
    });
    ...
    this.generalItems = [
      {
        ...
        name: "center",
        tooltip:
          'Location as a comma-separated coordinate pair (e.g. "40.714728,-73.998672")',
        required: true,
        onchange: render
      },
      {
      ...
      {
        type: "container",
        html: '<p style="font-weight: bold">Map options:</p>'
      },
      {
        type: "container",
        layout: "flex",
        ...
        items: [
          {
            ...
            label: "Zoom level",
            ariaLabel: "Zoom",
            tooltip: "The higher the zoom level, the closer the map",
            required: true,
            maxLength: 4,
            size: 2,
            selected: 10,
      ...
      {
        type: "container",
        html: '<p style="font-weight: bold">Static map only:</p>'
      },
      {
        name: "markers",
        type: "listbox",
        ...
        label: "Marker",
        ariaLabel: "Marker",
        tooltip: "Adds an optional pin to the map",
        required: true,
        values: [
          "No marker",
          "black",
      ...
      {
        type: "container",
        html: '<p style="font-weight: bold">Preview:</p>'
      },
      {
        type: "container",
        name: "map",
          ...
          items: [
            {
              type: "container",
              html:
                '<p style="font-weight: bold">Pick Location</p><div id="map"><p>Coming soon!</p><p>For now, enter coordiantes manually.</p></div>'
            },
            {
              type: "form",
              padding: 0,
